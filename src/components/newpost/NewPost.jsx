    ...
    <div className="mb-4 newpost-container p-2 py-3">
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          <div>
            {input !== 0 && <Image id="image-to-post" src={input} fluid />}
          </div>
        ...
        <div>
            <div className="d-flex align-items-center">
              <i id="plus" className="fas fa-plus d-flex justify-content-center align-items-center my-post-i"></i>
              <label id="select-to-upload-btn" className="d-flex justify-content-center py-1 my-1 mt-2 ">
                <i class="fas fa-image my-post-i d-flex justify-content-center align-items-center"></i>
                <input className="file-upload" type="file" multiple onChange={(e) => handleFile(e)} />
              </label>
          ...
          <Button variant="primary" onClick={ (e) => handleUpload(e)} style={{backgroundColor: "#e647be", border: "none"}}>
            Post
          </Button>
        </Modal.Footer>
      </Modal>

...
export const NewPostModal = ({ showModal, setShowModal, data,setRefreshComments ,refreshComments}) => {
  ...
  return (
    <div className="user-info d-flex align-items-center justify-content-between p-1 mb-4">
        ...
        <div className="d-flex align-items-center">
          ...
          <div className="d-flex flex-column mt-2">
            ...
            <div className="d-flex mt-2">
              <small className="text-secondary mr-2">2h</small>
              <small className="text-secondary mr-2">Replay</small>
            </div>
          </div>
        </div>
      </div>
      <div className="d-flex">
        ...
        <TiDeleteOutline onClick={() => deleteOneComment(comment._id)} className="comment-delete" />
      </div>
    </div>
  );
})
                    ...
                    >
                      ...
                      <div className="add-comment">
                        <div className="footer d-flex align-items-center justify-content-between">
                          ...
                          <button className="comment-button"onClick={() => addNewComment(data._id)}>>Post</button>
                        </div>
                      </div>
                    </div>
                    <hr />
                ...
                <buttton className="myCloseButton" onClick={closeModal}>
